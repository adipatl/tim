...
ons.bootstrap().service("PhoneGapService", function() {
    ...
    return {
        getUrl: function(id, param) {
            ...
            var url = "";
            if ("training" === id ? url = "https://survey.clicktools.com/app/survey/go.jsp?iv=1tsttlk7owagw&q11=" + employeeId : "meeting" === id ? url = "https://survey.clicktools.com/app/survey/go.jsp?iv=1o9a1wbal1tw8&q2=" + employeeId : "opportunity" === id ? url = "https://survey.clicktools.com/app/survey/go.jsp?iv=1iunnw6rju2f3&q2=" + employeeId : "clientfeedback" === id ? url = "https://survey.clicktools.com/app/survey/go.jsp?iv=3rviu4ldv474u&q2=" + employeeId : "enh" === id && (url = "https://survey.clicktools.com/app/survey/go.jsp?iv=2vkpvarxuqmvk&q2=" + employeeId), 
            "opportunity" === id) url = url + "&q1=" + opportunity; else for (var i = 1; i < contacts.length + 1; ++i) url = url + "&q" + i + "=" + contacts[i - 1].email;
            return url;
        },
